  ...
  return (
    <SectionShell className="bg-white">
      <div data-reveal>
        ...
        <h2 className="mt-5 text-2xl font-semibold text-brand-navy sm:text-3xl">From our expert team</h2>
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-3">
        {blogPosts.map((post, index) => (
          ...
          >
            ...
            <h3 className="mt-5 text-lg font-semibold text-brand-navy">{post.title}</h3>
            <Link
              href={post.href}
